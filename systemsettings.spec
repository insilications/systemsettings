...
Version  : 5.14.1
Release  : 7
URL      : https://download.kde.org/stable/plasma/5.14.1/systemsettings-5.14.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.1/systemsettings-5.14.1.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.1/systemsettings-5.14.1.tar.xz.sig
...
%prep
%setup -q -n systemsettings-5.14.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1539748107
mkdir -p clr-build
pushd clr-build
%cmake ..
