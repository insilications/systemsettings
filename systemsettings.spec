...
Version  : 5.23.2
Release  : 56
URL      : https://download.kde.org/stable/plasma/5.23.2/systemsettings-5.23.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.2/systemsettings-5.23.2.tar.xz
...
%prep
%setup -q -n systemsettings-5.23.2
cd %{_builddir}/systemsettings-5.23.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635364547
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/systemsettings-5.23.2/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/systemsettings/ea97eb88ae53ec41e26f8542176ab986d7bc943a
cp %{_builddir}/systemsettings-5.23.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/systemsettings/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/systemsettings-5.23.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/systemsettings/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/systemsettings-5.23.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/systemsettings/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/systemsettings-5.23.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/systemsettings/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/systemsettings-5.23.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/systemsettings/fa05e58320cb7c64786b26396f4b992579a628bc
cp %{_builddir}/systemsettings-5.23.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/systemsettings/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/systemsettings-5.23.2/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/systemsettings/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/systemsettings-5.23.2/runner/systemsettingsrunner.json.license %{buildroot}/usr/share/package-licenses/systemsettings/fd32940f125ecf08f9ad3cb0b64251688e927a90
pushd clr-build
%make_install
popd
